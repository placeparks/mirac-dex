  ...
  return (
    <div>
      ...
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to Mirac.eth Exchange!</h1>
          <div className={styles.description}>
           Ethereum Exchange by Mirac.eth &#60;&#62; Contact@ 00923157456388
          </div>
          <div>
            <button
      ...
      <footer className={styles.footer}>
        Made with &#10084; by Mirac.eth aka Hannan Shoukat
      </footer>
    </div>
  );
}